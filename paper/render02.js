...
(async () => {
  ...
  await p.goto('file:///home/user/paper/paper02.html', { waitUntil: 'networkidle' });
  await p.waitForTimeout(1500);
  await p.pdf({
    path: '/home/user/paper/moj-projection-scorecard-2026-02.pdf',
    format: 'A4',
    ...
    footerTemplate: `<div style="width:100%;font-family:'IBM Plex Mono',monospace;font-size:6.6pt;
      letter-spacing:.14em;color:#8A979A;padding:0 18mm;display:flex;justify-content:space-between;">
      <span>v1.0 &nbsp;·&nbsp; 4 SEPTEMBER 2026 &nbsp;·&nbsp; CC BY 4.0</span>
